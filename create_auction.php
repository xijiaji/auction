    ...
    <div class="card-body">
      ...
      <form method="post" action="create_auction_result.php" enctype="multipart/form-data">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
	        <div class="input-group">
              ...
              <input type="number" class="form-control" name="startprice" id="auctionStartPrice">
            </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <div class="input-group">
              ...
              <input type="number" class="form-control" name="reserveprice" id="auctionReservePrice">
            </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="datetime-local" class="form-control" name="enddate" id="auctionEndDate">
